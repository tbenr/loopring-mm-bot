...
export function signatureToHex(signature:any): string {
  return '0x' + new BigNumber(signature.Rx).toString(16).padStart(64,'0') + new BigNumber(signature.Ry).toString(16).padStart(64,'0') + new BigNumber(signature.s).toString(16).padStart(64,'0')
}
 ...
 * @returns {Buffer}
 */
export function toBuffer(mixed:Buffer|number|string): Buffer {
 ...
 * @returns {Buffer}
 */
export function zeroPad(num:number|string, places:number): Buffer {
 ...
 * @returns {string}
 */
export function toHex(mixed:number | BigNumber |  BN  | Buffer | string): string {
  if (
    typeof mixed === "number" ||
 ...
 * @returns {number}
 */
export function toNumber(mixed:number | BigNumber |  BN  | Buffer | string): number {
 ...
 * @returns {BigNumber}
 */
export function toBig(mixed:number | BigNumber |  BN  | Buffer | string): BigNumber {
 ...
 * @returns {BN}
 */
export function toBN(mixed:number | BigNumber |  BN  | Buffer | string): BN {
 ...
 * @returns {BN}
 */
export function fromGWEI(value:number | BigNumber |  BN  | Buffer | string): BigNumber {
 ...
 * @returns {BN}
 */
export function toGWEI(valueInWEI:number | BigNumber |  BN  | Buffer | string): BigNumber {
 ...
 * @returns {string}
 */
export function formatKey(mixed:number | BigNumber |  BN  | Buffer | string): string {
  if (mixed instanceof Buffer) {
 ...
 * @returns {string}
 */
export function formatAddress(mixed:number | BigNumber |  BN  | Buffer | string): string {
  if (mixed instanceof Buffer) {
 ...
 * @returns {string}
 */
export function clearHexPrefix(input:string): string {
  if (typeof input === "string") {
 ...
 * @returns {*}
 */
export function getDisplaySymbol(settingsCurrency:string): any {
 ...
 * @returns {string}
 */
export function toFixed(number:number | BigNumber, precision:number, ceil:boolean): string {
